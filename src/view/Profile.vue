  ...
  <section class="main__wrapper">
    <Title>
      ...
      <template v-slot:buttons>
        <router-link :to="TaskEdit">
          <Button class="btn default"> Добавить задачу</Button>
        </router-link>
        <Button class="btn primary" v-show="show" @click="modalVisable">
          Редактировать
        </Button>
      </template>
    </Title>
    <section class="board">
      <section class="board__profile">
          ...
          <img
            ...
            :src="
              currentProfile.photoUrl
                ? currentProfile.photoUrl
                : 'https://cdn-icons-png.flaticon.com/512/18/18601.png'
            "
            alt="avatar"
            width="186"
            height="186"
        ...
        <article class="board__profile-tasks">
          ...
          <div class="task_list" v-if="loading">loading...</div>
    ...
    <ModalWindow v-show="showModal">
      ...
      <form class="modal_board-form" id="modal_form" @submit="editProfile">
        <label htmlFor="username" class="taskPage-title"
